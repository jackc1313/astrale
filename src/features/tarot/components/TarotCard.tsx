...
const styles = StyleSheet.create({
  ...
  backPattern: { alignItems: "center", justifyContent: "center", gap: 8 },
  backSymbol: { fontSize: 32, color: colors.gold, opacity: 0.6 },
  backLabel: { fontFamily: "PlayfairDisplay-Bold", fontSize: 10, color: colors.gold, opacity: 0.4, letterSpacing: 4 },
});
